...
project_id = "88d548d900c3427bb3a60e13674e8178"     # project id 同region一一对应，参考https://support.huaweicloud.com/api-sis/sis_03_0008.html
...
def rasr_example():
    ...
    # websocket暂时不支持使用代理
    rasr_client = RasrClient(user_name="vinces", password="lNS1$gbjQSrHfvAEyCf_%teI",domain_name="vintcessun", use_aksk=False, region=region, project_id=project_id, callback=my_callback,
                             config=config)
    try:
        # step2 构造请求
