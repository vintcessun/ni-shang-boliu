...
int main(void)
{
    ...
    bflb_pwm_v2_channel_set_threshold(pwm, PWM_CH0, 0, 1700);   /* duty = (500-0)/1000 = 50% */
    bflb_pwm_v2_channel_set_threshold(pwm, PWM_CH1, 0, 1300); /* duty = (400-200)/1000 = 20% */
    bflb_pwm_v2_channel_set_threshold(pwm, PWM_CH2, 0, 1300);  /* duty = (999-99)/1000 = 90% */
    bflb_pwm_v2_channel_set_threshold(pwm, PWM_CH3, 0, 1300); /* duty = (900-300)/1000 = 60% */
    ...
    //bflb_pwm_v2_channel_negative_start(pwm, PWM_CH0);//24  26
    //bflb_pwm_v2_channel_positive_start(pwm, PWM_CH1);
    //bflb_pwm_v2_channel_negative_start(pwm, PWM_CH1);//29  25
    //bflb_pwm_v2_channel_positive_start(pwm, PWM_CH2);
    //bflb_pwm_v2_channel_negative_start(pwm, PWM_CH2);//28  30
  ...
  //  bflb_pwm_v2_channel_positive_stop(pwm, PWM_CH1);
   // bflb_pwm_v2_channel_negative_stop(pwm, PWM_CH1);s
